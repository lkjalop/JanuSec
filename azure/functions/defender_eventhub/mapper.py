...
_TYPE_MAP_HINTS = {
    # Map common Defender categories to heuristic posture types
...
def normalize_defender_event(evt: Dict[str, Any]) -> Dict[str, Any]:
    """Normalize a single Defender/Policy event."""
    # Try common fields; Azure outputs vary by export pipeline
    ...
    # Map category to a posture type hint; fall back to category text
    ...
    try:
        # Convert ISO8601 to epoch seconds if needed
