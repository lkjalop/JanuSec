...
Revises: 0008_repair_decisions_table
"""
...
down_revision = "0008_repair_decisions_table"
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    if not sa.inspect(bind).has_table("evidence_ledger"):
        ...
        op.create_index(
            "idx_evidence_ledger_type", "evidence_ledger", ["tenant_id", "case_id", "record_type", "appended_at"]
        )
...
def downgrade():
    # Destructive downgrade is intentionally explicit; evidence is not silently deleted.
    pass
