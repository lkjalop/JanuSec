...
class TestKillChain:
    ...
    def test_single_finding(self):
        ...
        assert chain[0].mitre_techniques == []
        assert chain[0].candidate_mitre_techniques
    ...
    def test_causal_linking(self):
        ...
        assert chain[0].relation_to_next == "temporal_precedes"
    ...
    def test_mitre_techniques_populated(self):
        ...
        chain = extract_kill_chain([vf])
        assert chain[0].mitre_techniques == []
        assert any("T1567" in t or "T1048" in t for t in chain[0].candidate_mitre_techniques)
...
class TestNarrator:
    ...
    def test_prompt_with_kill_chain(self):
        ...
        assert "Case chronology" in prompt
