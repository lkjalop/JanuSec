...
os.environ['JWT_TEST_SECRET'] = 'jwt-test-secret-at-least-32-bytes'
...
def test_admin_promote_and_alias_and_label():
    ...
    try:
        ...
        pyjwt = None
    if pyjwt:
        token = pyjwt.encode({'sub':'ci-user','tenant_id':'default','scopes':['factors.search'], 'aud':'janusec', 'iss':'ci'}, os.environ['JWT_TEST_SECRET'], algorithm='HS256')
